...
$sql = "INSERT INTO `users` (`id`, `name`, `role`, `phone`, `password`, `email`, `image`, `who_it_recorded`, `created_at`, `position`) VALUES (NULL, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
$result->bindValue(7, $who_it_recorded);
$result->bindValue(8, $date);
$result->bindValue(9, $position);
