...
<!-- content -->
<div class="title">
    <div class="title-text">پیام های ارسال شده</div>
</div>
<br>
    ...
    <table class="fl-table">
        <thead>
            <tr>
                ...
                <th class="th"> انفرادی به</th>
                <th class="th"> گروهی به</th>
        ...
        <tbody>
            ...
            $sql = "SELECT *, (SELECT `name` FROM `users` WHERE users.id = messages.user_id) AS `username`, (SELECT `name` FROM `sections` WHERE sections.id = messages.section_id) AS `sectionName` FROM `messages` WHERE user_id_sender = ? LIMIT $start, $limit";
