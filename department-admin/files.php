...
<!-- content -->
<div class="title">
    <div class="title-text">فایل های ارسال شده</div>
</div>
<br>
<div class="content-container">
    <table class="fl-table">
        ...
        <tbody>
            ...
            $sql = "SELECT *, (SELECT `name` FROM `users` WHERE users.id = documents.user_id) AS `username` FROM `documents` WHERE user_id_sender = ? LIMIT $start, $limit";
            ...
            foreach ($userInfos as $userInfo) { ?>
                <tr>
                    ...
                    <td><a href="file-details.php?id=<?= $userInfo['id'] ?>" class="success">نمایش</a></td>
